                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center"> 
                            <img src="{{URL::asset('../storage/app/'.$products->image)}}" class="rounded-circle" width="150" />
                            <h4 class="card-title mt-10">{{ $products->name}}</h4>
                            <p class="card-subtitle">{{ ($products->discount_percentage/100)*$products->price}}</p>
                    ...
                    <div class="card-body"> 
                        ...
                        <small class="text-muted d-block pt-10">{{ __('gst')}}</small>
                        <h6>{{ $products->gst.'%' }}</h6> 
                        <small class="text-muted d-block pt-10">{{ __('hsn_code')}}</small>
                        <h6>{{ $products->hsn_code}}</h6> 
                        {{-- <h6>{{ $products->house_address.','.$products->street.','.$products->city.','.$products->state.','.$products->pincode }}</h6> --}}
                        <div class="map-box">
                            ...
                            {{-- <iframe src="{{URL::asset('../storage/app/'.$products->image)}}" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe> --}}
                        </div> 
                        ...
                        <table id="data_table" class="table">
                            ...
                            <tbody>
                                @foreach ($orders as $order)
                                    ...
                                    <td>{{ $order->status}}</td>
                                    {{-- <td><img src="../img/products/1.jpg" class="table-user-thumb" alt=""></td> --}}
                                    <td>{{ $order->qua}}</td>
                                    <td>{{ $order->amount}}</td>
                                    <td>
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="card mb-5 mb-lg-0">
                  <img src="{{ URL::asset('../storage/app/'.$products->image1) }}">
                </div>
              </div>
               <div class="col-lg-4">
                <div class="card mb-5 mb-lg-0">
                  <img src="{{ URL::asset('../storage/app/'.$products->image2) }}">
                </div>
              </div>
               <div class="col-lg-4">
                <div class="card mb-5 mb-lg-0">
                  <img src="{{ URL::asset('../storage/app/'.$products->image3) }}">
                </div>
              </div>
          </div>
        </section>
